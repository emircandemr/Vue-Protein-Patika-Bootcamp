export const toast = (message = "Default Message", options = {}) => {
	...
	const toast = {
		...
		success: (description = 'Success Notification !', options = {}) => {
			const { position = 'top-right', icon = "check_circle", duration = 5000 ,
